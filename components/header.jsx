  ...
  return (
    <header className="w-full px-4 sm:px-6 lg:px-20 py-4 sm:py-6 lg:py-8 flex flex-wrap items-center justify-between bg-black border-b border-gray-800 bg-transparent">
      <div className="flex items-center justify-between w-full md:w-auto">
        ...
        <button
          onClick={toggleMenu}
          className="md:hidden text-gray-300 hover:text-[#344047] focus:outline-none"
      ...
      >
        <ul className="flex flex-col md:flex-row md:space-x-6 space-y-2 md:space-y-0 text-lg text-gray-300">
          <li>
            <Link
              href="/"
              className="hover:text-[#344047] block py-2 md:py-0"
        ...
        {isConnected ? (
          <div className="flex justify-center md:justify-end">
            <button
              ...
              className="bg-[#344047] hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm transition w-full md:w-36"
            >
          ...
          <button
            ...
            className="bg-[#344047] hover:[#344047] text-white px-4 py-2 rounded-lg text-sm transition w-full md:w-36"
          >
            Connect Wallet
          </button>
        )}
